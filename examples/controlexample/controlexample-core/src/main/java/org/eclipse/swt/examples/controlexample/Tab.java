...
abstract class Tab {
	...
	static final boolean RTL_SUPPORT_ENABLE = false; // "win32".equals(SWT.getPlatform()) || "gtk".equals(SWT.getPlatform());
...
//		new EventInfo ("Settings", SWT.Settings, 0, 0, new Event()),  // note: this event only goes to Display
	...
	void createColorAndFontGroup () {
		...
		colorAndFontTable = new Table(colorGroup, SWT.BORDER | SWT.V_SCROLL | SWT.SINGLE);
